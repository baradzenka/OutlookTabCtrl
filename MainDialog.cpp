...
{	if(CDialog::OnCreate(lpCreateStruct) == -1)
	...
	m_OutlookTabCtrl.SetNotifyManager(this);
		// 
	m_OutlookTabCtrl.CreateStripesImages(NULL,IDB_STRIPE_NORMAL,IDB_STRIPE_DISABLE,true,24);
	m_OutlookTabCtrl.CreateButtonsImages(NULL,IDB_BUTTON_NORMAL,IDB_BUTTON_DISABLE,true,16);
		// 
